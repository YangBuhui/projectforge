...
public class UserTest extends AbstractTestBase
{
  ...
  {
    assertEquals("Empty password not allowed.", UserDao.MESSAGE_KEY_PASSWORD_QUALITY_CHECK,
        userDao.checkPasswordQuality(null));
    assertEquals("Password with less than 6 characters not allowed.", UserDao.MESSAGE_KEY_PASSWORD_QUALITY_CHECK,
        userDao
