...
public class AbstractHistorizableBaseDOTest extends AbstractTestBase
{
  ...
  public void testNonHistorizableProperties()
  {
    ...
    Set<String> set = HistoryServiceManager.get().getHistoryService().getNoHistoryProperties(PfEmgrFactory.get(),
        task.getClass());
    ...
    set = HistoryServiceManager.get().getHistoryService().getNoHistoryProperties(PfEmgrFactory.get(), order.getClass());
