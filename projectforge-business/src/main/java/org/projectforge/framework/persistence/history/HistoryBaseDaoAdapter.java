...
public class HistoryBaseDaoAdapter
{
  ...
  public static List<? extends HistoryEntry> getHistoryEntries(BaseDO<?> ob)
  {
    ...
    List<? extends HistoryEntry> ret = PfEmgrFactory.get().runWoTrans((emgr) -> {
  ...
  public static ModificationStatus wrappHistoryUpdate(BaseDO<?> newo, BaseDO<?> dbo,
      Supplier<ModificationStatus> callback)
  {
    long begin = System.currentTimeMillis();
    ...
    ModificationStatus result = PfEmgrFactory.get().runInTrans((emgr) -> {
